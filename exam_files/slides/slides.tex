...
\begin{frame}{Dataset e Preprocessing (\texttt{preprocess.py})}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
    ...
    \begin{columns}[T]
        \begin{column}{0.46\textwidth}
            ...
            \begin{block}{Cause del basso F1 sui $c$-jet}
                \begin{itemize}
                    \item Vita media intermedia dei mesoni charm $\Rightarrow$ vertice secondario ambiguo
                    \item Dataset fortemente sbilanciato: $c$-jet e $\tau$-jet sottorappresentati
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.50\textwidth}
